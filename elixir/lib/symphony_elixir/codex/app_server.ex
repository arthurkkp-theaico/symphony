defmodule SymphonyElixir.Codex.AppServer do
  ...
  @type session :: %{
          ...
          tracker_project_key: String.t() | nil,
          tracker_terminal_states: [String.t()],
          thread_id: String.t(),
          workspace: Path.t(),
      ...
      with {:ok, session_policies} <- session_policies(expanded_workspace, worker_host),
        ...
        {:ok,
         %{
           ...
           tracker_project_key: tracker.project_key,
  ...
  def run_turn(
        %{
          ...
          tracker_kind: tracker_kind,
          tracker_project_key: tracker_project_key,
          tracker_terminal_states: tracker_terminal_states,
          thread_id: thread_id,
          workspace: workspace
        },
        prompt,
    ...
    tool_executor =
      Keyword.get(opts, :tool_executor, fn tool, arguments ->
        DynamicTool.execute(tool, arguments,
          workspace: workspace,
          github_repository: Config.settings!().workspace.github_repository,
  ...
  defp start_thread(
    ...
    send_message(port, %{
      ...
      "params" => %{
        ...
        "cwd" => workspace,
        "dynamicTools" => DynamicTool.tool_specs(tracker_kind)
      }
    })
