...
This directory contains the Elixir agent orchestration service that polls Linear or Jira, creates per-issue workspaces, and runs Codex in app-server mode.
